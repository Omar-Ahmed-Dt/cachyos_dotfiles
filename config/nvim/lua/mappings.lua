...
-- Markdown preview in browser with Ctrl+P
vim.api.nvim_create_autocmd("FileType", {
  pattern = "markdown",
  callback = function()
    map("n", "<C-p>", "<cmd>MarkdownPreviewToggle<CR>", { desc = "markdown preview in browser", buffer = true })
  end,
})
...
-- map("n", "<C-i>", "<cmd>w<CR>", { desc = "general save file" })
...
-- map("n", "<leader>w", "<cmd>NvimTreeToggle<CR>", { desc = "nvimtree toggle window" })
...
--   vim.cmd("cd " .. dir)
--   vim.cmd("enew")
-- end, { desc = "new buffer in current file dir" })
...
-- dash
map("n", "<leader>d", "<cmd>Nvdash<CR>", { desc = "open dash" })
